    ...
    const steps: IRewardSteps[] = [
        {
            ...
            image: '/attachments/rewards/get-points.svg'
        },
        {
            ...
            image: '/attachments/rewards/collect-rewards.svg'
        },
        {
            color: "bg-[#373636]",
            isLight: true,
            ...
            image: '/attachments/rewards/book-video-calls.png'
        }
    ]

    return (
        <div className='mt-24 px-4 py-12 flex flex-col items-center justify-center gap-y-8 w-full'>
            <h2 className='text-2xl lg:text-4xl w-3/5 lg:w-full text-center font-extrabold text-black uppercase font-familjen'>
